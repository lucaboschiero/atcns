...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, choices=["mnist", "cifar", "cifar100", "imdb", "fmnist", "femnist"], default="mnist")
    parser.add_argument("--loader_type", type=str, choices=["iid", "byLabel", "dirichlet", "femnist"], default="iid")
