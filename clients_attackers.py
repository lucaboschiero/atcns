...
from utils.backdoor_utils import Backdoor_Utils, Backdoor_Utils1
from clients import *
...
class Attacker_Backdoor78to4(Client):
    def __init__(self, cid, model, dataLoader, optimizer, criterion=F.nll_loss, device='cpu', inner_epochs=1):
        super(Attacker_Backdoor78to4, self).__init__(cid, model, dataLoader, optimizer, criterion, device, inner_epochs)
        self.utils = Backdoor_Utils1()
