...
execution_log_path = "./logs/execution_log-fmnist-sf-scalability.txt"
...
epochs = 30
total_clients = [20, 60, 80, 100]
#attacker_percentage = [10, 20, 30, 40, 50, 60, 70]
attacker_percentage = [10, 40, 70]
...
for num_clients in total_clients: 
    for percentage in attacker_percentage:
        num_attacker = int((num_clients * percentage) / 100)
        for lfpercentage in labelflipping_percentage:
            ...
            for ar in aggRule:
                ...
                with open(execution_log_path, "a") as log_file:
                    ...
                    log_file.write(f"aggRule: {ar}, num_clients: {num_clients}, attacker_percentage: {percentage}, labelflipping_percentage: {lfpercentage}, num_labelflipping_attacker: {num_labelflipping_attacker}, num_backdoor_attacker: {num_backdoor_attacker}\n")
